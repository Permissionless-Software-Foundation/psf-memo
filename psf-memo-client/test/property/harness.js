/*
  ...
  The client runs its unit tests with node:test and has no property-based
  generator, so this module provides a deterministic, seeded pseudo-random
  generator plus a helper to run a property across many samples and report a
  counterexample. All generation is seeded, so runs are reproducible.
*/
